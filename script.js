...
// =====================================================================
// SHOE DATABASE — array-ified matching properties
// =====================================================================
// numberOfMiles, typeOfRunning, typeOfSurface, preferredCushion, budget,
// and footStrike are now arrays representing every value a shoe can
// satisfy (not just its primary tag). Match logic:
//   if (shoe.numberOfMiles.includes(userAnswer) && shoe.typeOfRunning.includes(userAnswer) && ...) -> match
//
// Expansion rules used:
//   LOOSE  — numberOfMiles, footStrike: expand to adjacent tier(s) only
//   STRICT — typeOfSurface, preferredCushion, typeOfRunning, budget: little/no expansion
//     - typeOfSurface: road also covers "treadmill"; trail/track stay single-value
//     - preferredCushion: no expansion
//     - typeOfRunning: no expansion EXCEPT "allrounder" also covers longeasyruns + speedwork
//     - budget: expands UPWARD ONLY (under150 -> also matches under200/none, never reverse)
// =====================================================================
...
const EndorphinXC = {
    ...
    numberOfMiles: ["0-10", "10-25", "25+"],
    typeOfRunning: ["racing"],
    typeOfSurface: ["trail"],
    preferredCushion: ["responsive"],
    budget: ["under200", "none"],
...
const EndorphinPro = {
    ...
    image: "Images/endorphinPro5.png",
...
const EndorphinElite = {
    ...
    image: "Images/EndorphinElite3.png",
    link: "https://www.runningwarehouse.com/Saucony_Endorphin_Elite_3/descpage-SEE3U02.html?_gl=1*rzs74i*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9ZLSBhCcARIsAEhGKgM2IPw-U7h6bsnPefWKaWzF9qvuHpSDSAFKkjGF4dkp_GlSHoPPshMaArncEALw_wcB&gbraid=0AAAAADka_jj_SS1eiwx0izGYftlfNpVar",
    ...
    numberOfMiles: ["10-25", "25+"],
    typeOfRunning: ["racing"],
    typeOfSurface: ["road", "treadmill"],
    preferredCushion: ["responsive"],
    budget: ["none"],
    footStrike: ["forefoot", "midfoot"],
    historyOfInjury: "no",
};
...
const Triumph = {
    ...
    image: "Images/SauconyTriumph24.png",
    link: "https://www.runningwarehouse.com/Saucony_Triumph_24/descpage-ST24M1.html?_gl=1*rzs74i*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9ZLSBhCcARIsAEhGKgM2IPw-U7h6bsnPefWKaWzF9qvuHpSDSAFKkjGF4dkp_GlSHoPPshMaArncEALw_wcB&gbraid=0AAAAADka_jj_SS1eiwx0izGYftlfNpVar",
...
const SauconyRide = {
    ...
    image: "Images/SauconyRide19.png",
    link: "https://www.runningwarehouse.com/Saucony_Ride_19/descpage-SR19M10.html?_gl=1*1do8zm2*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9ZLSBhCcARIsAEhGKgM2IPw-U7h6bsnPefWKaWzF9qvuHpSDSAFKkjGF4dkp_GlSHoPPshMaArncEALw_wcB&gbraid=0AAAAADka_jj_SS1eiwx0izGYftlfNpVar",
    ...
    numberOfMiles: ["10-25", "25+"],
    typeOfRunning: ["allrounder", "longeasyruns", "speedwork"],
    typeOfSurface: ["road", "treadmill"],
    preferredCushion: ["responsive"],
    budget: ["under150", "under200", "none"],
    footStrike: ["heel", "midfoot", "forefoot"],
    historyOfInjury: "no",
}
...
const EndorphinAzura = {
    ...
    image: "Images/EndorphinAzura.png",
    link: "https://www.runningwarehouse.com/Saucony_Endorphin_Azura/descpage-SEAZM1.html?_gl=1*1do8zm2*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9ZLSBhCcARIsAEhGKgM2IPw-U7h6bsnPefWKaWzF9qvuHpSDSAFKkjGF4dkp_GlSHoPPshMaArncEALw_wcB&gbraid=0AAAAADka_jj_SS1eiwx0izGYftlfNpVar",
...
const BrooksGhost = {
    ...
    image: "Images/BrooksGhost18.png",
    link: "https://www.runningwarehouse.com/Brooks_Ghost_18/descpage-B18GHM1.html",
...
const Glycerin23 = {
    ...
    image: "Images/BrooksGlycerin23.png",
    link: "https://www.runningwarehouse.com/Brooks_Glycerin_23/descpage-B23GLM7.html",
...
const GlycerinFlex = {
    ...
    image: "Images/BrooksGlycerinFlex.png",
    link: "https://www.runningwarehouse.com/Brooks_Glycerin_Flex/descpage-BGFV1M4.html",
...
const HyperionMax3 = {
    ...
    image: "Images/BrooksHyperionMax3.png",
    link: "https://www.runningwarehouse.com/Brooks_Hyperion_Max_3/descpage-B3HYXM0.html",
...
const NikePegasus41 = {
    ...
    image: "Images/NikePegasus42.png",
    link: "https://www.runningwarehouse.com/Nike_Pegasus_42/descpage-NAP42M6.html",
...
const PegasusPremium = {
    ...
    link: "https://www.runningwarehouse.com/Nike_Pegasus_Premium/descpage-NMPP003.html",
...
const StructurePlus = {
    ...
    image: "Images/StructurePlus.png",
    link: "https://www.runningwarehouse.com/Nike_Structure_Plus/descpage-NSPLM02.html",
...
const ONcloudmonster = {
    ...
    image: "Images/Cloudmonster3.png",
    link: "https://www.runningwarehouse.com/On_Cloudmonster_3/descpage-ONCM3M3.html",
...
const Cloudspike10k = {
    ...
    numberOfMiles: ["10-25", "25+"], // normalized from original nonstandard "5+" tag
    typeOfRunning: ["racing"],
    typeOfSurface: ["track"],
    preferredCushion: ["responsive"],
    budget: ["under200", "none"],
...
const CloudboomStrike2 = {
    ...
    image: "Images/CloudboomStrike2.png",
    link: "https://www.runningwarehouse.com/On_Cloudboom_Strike_2/descpage-OCBS2U2.html",
...
const CloudmonsterHyper = {
    ...
    image: "Images/Cloudmonster3Hyper.png",
    link: "https://www.runningwarehouse.com/On_Cloudmonster_3_Hyper/descpage-O3CMHM7.html",
...
const Mach6 = {
    ...
    image: "Images/Mach7.png",
    link: "https://www.runningwarehouse.com/HOKA_Mach_7/descpage-HM7M01.html",
...
const CieloX1 = {
    ...
    image: "Images/Cielox1.png",
    link: "https://www.runningwarehouse.com/HOKA_Cielo_X1_30/descpage-HCX13U1.html",
...
const MagicSpeed = {
    ...
    image: "Images/MagicSpeed5.png",
    link: "https://www.runningwarehouse.com/ASICS_Magic_Speed_5/descpage-AS5MSU1.html",
...
const GelNimbus27 = {
    ...
    image: "Images/GelNimbus28.png",
    link: "https://www.runningwarehouse.com/ASICS_Gel_Nimbus_28/descpage-AGN28M2.html",
...
const Superblast = {
    ...
    image: "Images/Superblast3.png",
    link: "https://www.runningwarehouse.com/ASICS_SUPERBLAST_3/descpage-AS3SB1.html",
...
const Metaspeed = {
    ...
    image: "Images/Metaspeedsky.png",
    link: "https://www.runningwarehouse.com/ASICS_METASPEED_Sky_Tokyo/descpage-AMSSTU0.html",
...
const Megablast = {
    ...
    image: "Images/Megablast.png",
    link: "https://www.runningwarehouse.com/ASICS_MEGABLAST/descpage-ASMBU4.html",
...
const GelCumulus28 = {
    ...
    image: "Images/GelCumulus28.png",
    link: "https://www.runningwarehouse.com/ASICS_Gel_Cumulus_28/descpage-AGC28M2.html",
...
const Supernova = {
    ...
    image: "Images/SupernovaRise3.png",
    link: "https://www.runningwarehouse.com/adidas_Supernova_Rise_3/descpage-A3SNRM2.html",
...
const Morev5 = {
    ...
    image: "Images/Morev6.png",
    link: "https://www.runningwarehouse.com/New_Balance_Fresh_Foam_X_More_v6/descpage-NBMO6M4.html",
...
const NewBalance1080 = {
    ...
    image: "Images/1080v15.png",
    link: "https://www.runningwarehouse.com/New_Balance_1080_v15/descpage-NM8015E.html",
...
const RebelTrail = {
    ...
    image: "RebelTrail.png",
    link: "https://www.runningwarehouse.com/New_Balance_FuelCell_Rebel_Trail/descpage-NBRTM0.html",
...
// Checks whether a shoe matches the user's answer.
// Works with both single values and arrays.
function matchesFilter(shoeValue, userValue) {

    if (Array.isArray(shoeValue)) {
        return shoeValue.includes(userValue);
    }

    return shoeValue === userValue;
}
...
button.addEventListener("click", function generateShoe() {
    ...
    for (const filter of filterOrder) {
        ...
        const survivors = remainingShoes.filter(item =>
            matchesFilter(item.shoe[filter], userInput[filter])
        );
